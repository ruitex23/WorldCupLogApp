...
import static utils.WorldCupCommons.setupRadioButtonListeners;
...
public class AddGameSetsController {
    ...
    public void setupScreen() {
        ...
        //the toggle that defines automatic/manual mode
        setupToggle();
    ...
    private void setTextFieldsOnlyNumeric() {
        WorldCupCommons.setTextFieldsOnlyNumeric(player1SetsWon);
        WorldCupCommons.setTextFieldsOnlyNumeric(player2SetsWon);
        ...
        WorldCupCommons.setTextFieldsOnlyNumeric(player1TotalPointsTextField);
        WorldCupCommons.setTextFieldsOnlyNumeric(player2TotalPointsTextField);

        player1TotalInningsTextField.textProperty().addListener((observable, oldValue, newValue) -> {
        ...
        player2TotalInningsTextField.textProperty().addListener((observable, oldValue, newValue) -> {
            if (!newValue.matches("\\d*")) {
    ...
    private void addRadioButtonListeners() {
        setupRadioButtonListeners(last32RadioButton, last16RadioButton,
                quarterFinalsRadioButton, semiFinalsRadioButton, theFinalRadioButton, thirdForthRadioButton);
    }
    ...
    private void setupAutomaticFeatureListeners() {
        ...
        player2SetsWon.textProperty().addListener((observable, oldValue, newValue) -> {
            if(automaticToggle.isSelected()) {
                //apenas verifica que o resultado final já foi preenchido para os 2 jogadores
                //se o user começar a preencher pelo jogador 2, neste if bate na barra
                if(StringUtils.isNotBlank(player1SetsWon.getText()) && StringUtils.isNotBlank(player2SetsWon.getText())) {
                    ...
                    if(p1Pts.compareTo(3) == 0 && p2Pts.compareTo(0) == 0) {
                        //P1 tem 15 pontos no Set 1
                        player1Set1ChoiceBox.getSelectionModel().select(16);
                        //P1 tem 15 pontos no Set 2
                        player1Set2ChoiceBox.getSelectionModel().select(16);
                        //P1 tem 15 pontos no Set 3
                        player1Set3ChoiceBox.getSelectionModel().select(16);
                        //todos os outros estão desactivados por razões óbvias
                        player2Set1ChoiceBox.setDisable(false);
                        player2Set2ChoiceBox.setDisable(false);
                        player2Set3ChoiceBox.setDisable(false);
                        //P2 já não pode ter nenhum set com 15 pontos porque perdeu todos
                        player2Set1ChoiceBox.setItems(pointsMinusList);
                        player2Set1ChoiceBox.getSelectionModel().selectFirst();
                        player2Set2ChoiceBox.setItems(pointsMinusList);
                        player2Set2ChoiceBox.getSelectionModel().selectFirst();
                        player2Set3ChoiceBox.setItems(pointsMinusList);
                        player2Set3ChoiceBox.getSelectionModel().selectFirst();
                        player1TotalInningsTextField.setDisable(false);
                        player2TotalInningsTextField.setDisable(false);
                    ...
                    //P2 vence 3-0
                        ...
                        player1Set1ChoiceBox.getSelectionModel().selectFirst();
                        player1Set2ChoiceBox.setItems(pointsMinusList);
                        player1Set2ChoiceBox.getSelectionModel().selectFirst();
                        player1Set3ChoiceBox.setItems(pointsMinusList);
                        player1Set3ChoiceBox.getSelectionModel().selectFirst();
                        player2TotalInningsTextField.setDisable(false);
                        player1TotalInningsTextField.setDisable(false);
                        player1TotalInningsTextField.setText("");
        ...
        player1Set1ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
...
//								player2Set1ChoiceBox.setDisable(true);
        ...
        player1Set2ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString()) && new_value.intValue() > 0
                        && StringUtils.isNumeric(player1Set2ChoiceBox.getItems().get(new_value.intValue()))) {
                    Integer p1Pts = Integer.valueOf(player1Set2ChoiceBox.getItems().get(new_value.intValue()));
                    if (p1Pts.compareTo(15) >= 0) {
                        player2Set2ChoiceBox.setItems(pointsMinusList);
                        player2Set2ChoiceBox.getSelectionModel().selectFirst();
                    }
                } else {
        ...
        player1Set3ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString()) && new_value.intValue() > 0
                        && StringUtils.isNumeric(player1Set3ChoiceBox.getItems().get(new_value.intValue()))) {
                    Integer p1Pts = Integer.valueOf(player1Set3ChoiceBox.getItems().get(new_value.intValue()));
                    Integer p1SetsResult = Integer.valueOf(player1SetsWon.getText());
                    Integer p2SetsResult = Integer.valueOf(player2SetsWon.getText());
        ...
        player1Set4ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if (automaticToggle.isSelected()) {
                if (StringUtils.isNumeric(new_value.toString()) && new_value.intValue() > 0
                        && StringUtils.isNumeric(player1Set4ChoiceBox.getItems().get(new_value.intValue()))) {
                    Integer p1Pts = Integer.valueOf(player1Set4ChoiceBox.getItems().get(new_value.intValue()));
                    Integer p1SetsResult = Integer.valueOf(player1SetsWon.getText());
                    Integer p2SetsResult = Integer.valueOf(player2SetsWon.getText());
                    ...
                    if (p1SetsResult.compareTo(1) == 0 && p2SetsResult.compareTo(3) == 0 ||
                        ...
                        player2Set4ChoiceBox.getSelectionModel().selectFirst();
                    }
                }
            }
        });

        player1Set5ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString()) && new_value.intValue() > 0
                        && StringUtils.isNumeric(player1Set5ChoiceBox.getItems().get(new_value.intValue()))) {
                    Integer p1Pts = Integer.valueOf(player1Set5ChoiceBox.getItems().get(new_value.intValue()));
                    Integer p1SetsResult = Integer.valueOf(player1SetsWon.getText());
                    Integer p2SetsResult = Integer.valueOf(player2SetsWon.getText());
                    ...
                    if(p1SetsResult.compareTo(2) == 0 && p2SetsResult.compareTo(3) == 0 || p1SetsResult.compareTo(1) == 0 && p2SetsResult.compareTo(4) == 0) {
                        ...
                        player2Set5ChoiceBox.getSelectionModel().selectFirst();
                    }
                } else {
                    player1TotalPointsTextField.setText("");
                }
        ...
        player1Set6ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString()) && new_value.intValue() > 0
                        && StringUtils.isNumeric(player1Set6ChoiceBox.getItems().get(new_value.intValue()))) {
                    Integer p1Pts = Integer.valueOf(player1Set6ChoiceBox.getItems().get(new_value.intValue()));
                    Integer p1SetsResult = Integer.valueOf(player1SetsWon.getText());
                    Integer p2SetsResult = Integer.valueOf(player2SetsWon.getText());
                    //P2 vence 3-2, logo pelo automatismo, este sera o ultimo set preenchido para o jogador 1,
                    //logo depois deste pode acertar as contas dos pontos do jogador 1
                    if(p1SetsResult.compareTo(2) == 0 && p2SetsResult.compareTo(4) == 0) {
                        ...
                        if(aux) {
                            ...
                            int totalPoints = totalPointsSet1 + totalPointsSet2 + totalPointsSet3 + totalPointsSet4 +
                                    totalPointsSet5 + p1Pts;
                            player1TotalPointsTextField.setText(String.valueOf(totalPoints));
                        }
                    } else if (p1Pts.compareTo(15) >= 0) {
                        player2Set6ChoiceBox.setItems(pointsMinusList);
                        player2Set6ChoiceBox.getSelectionModel().selectFirst();
                    }
                } else {
                    player1TotalPointsTextField.setText("");
                }
        ...
        player1Set7ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString()) && new_value.intValue() > 0
                        && StringUtils.isNumeric(player1Set7ChoiceBox.getItems().get(new_value.intValue()))) {
                    Integer p1Pts = Integer.valueOf(player1Set7ChoiceBox.getItems().get(new_value.intValue()));
                    Integer p1SetsResult = Integer.valueOf(player1SetsWon.getText());
                    Integer p2SetsResult = Integer.valueOf(player2SetsWon.getText());
                    //P2 vence 3-2, logo pelo automatismo, este sera o ultimo set preenchido para o jogador 1,
                    //logo depois deste pode acertar as contas dos pontos do jogador 1
                    if(p1SetsResult.compareTo(3) == 0 && p2SetsResult.compareTo(4) == 0) {
                        ...
                        if(aux) {
                            ...
                            int totalPoints = totalPointsSet1 + totalPointsSet2 + totalPointsSet3 + totalPointsSet4 +
                                    totalPointsSet5 + totalPointsSet6 + p1Pts;
                            player1TotalPointsTextField.setText(String.valueOf(totalPoints));
                        }
                    } else if (p1Pts.compareTo(15) >= 0) {
                        player2Set7ChoiceBox.setItems(pointsMinusList);
                        player2Set7ChoiceBox.getSelectionModel().selectFirst();
                    }
                } else {
                    player1TotalPointsTextField.setText("");
                }
        ...
        player2Set1ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                //casos de 3-1
        ...
        player2Set2ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
        ...
        player2Set3ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
        ...
        player2Set4ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString())
                        && new_value.intValue() > 0
        ...
        player2Set5ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString())
                        && new_value.intValue() > 0
                    ...
                    if(p1SetsResult.compareTo(3) == 0 && p2SetsResult.compareTo(2) == 0 || p1SetsResult.compareTo(4) == 0 && p2SetsResult.compareTo(1) == 0
                            || p1SetsResult.compareTo(2) == 0 && p2SetsResult.compareTo(3) == 0) {
                        //verifica se os 5 sets estao com valores numericos
                        boolean aux = StringUtils.isNumeric(player2Set1ChoiceBox.getSelectionModel().getSelectedItem()) &&
                                StringUtils.isNumeric(player2Set2ChoiceBox.getSelectionModel().getSelectedItem()) &&
                                StringUtils.isNumeric(player2Set3ChoiceBox.getSelectionModel().getSelectedItem()) &&
        ...
        player2Set6ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString())
                        && new_value.intValue() > 0
        ...
        player2Set7ChoiceBox.getSelectionModel().selectedIndexProperty().addListener((ov, value, new_value) -> {
            if(automaticToggle.isSelected()) {
                if(StringUtils.isNumeric(new_value.toString())
                        && new_value.intValue() > 0
